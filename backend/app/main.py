...
from .routers import reports_router, letters_router, auth_router, disputes_router, scheduler_router, copilot_router, outcomes_router, admin_router, cfpb_router
...
app.include_router(cfpb_router)
