...
def get_relevant_cases_for_violation(violation_type: str) -> List[CaseLawCitation]:
    ...
    violation_category_map = {
        ...
        # Cross-bureau discrepancies -> ACCURACY (furnisher reporting different data to different bureaus)
        "dofd_mismatch": CaseLawCategory.ACCURACY,
        "balance_mismatch": CaseLawCategory.ACCURACY,
        "status_mismatch": CaseLawCategory.ACCURACY,
        "date_opened_mismatch": CaseLawCategory.ACCURACY,
        "high_credit_mismatch": CaseLawCategory.ACCURACY,
        "credit_limit_mismatch": CaseLawCategory.ACCURACY,
        "payment_status_mismatch": CaseLawCategory.ACCURACY,
        "account_type_mismatch": CaseLawCategory.ACCURACY,
        "date_closed_mismatch": CaseLawCategory.ACCURACY,
        "cross_bureau_discrepancy": CaseLawCategory.ACCURACY,
        "cross_bureau_contradiction": CaseLawCategory.ACCURACY,
