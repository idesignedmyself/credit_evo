...
LEGAL_SECTION_SPECS: List[SectionSpec] = [
    ...
    SectionSpec(
        ...
        position=2,
        required=False,
        header_patterns=[r"^(RE:|Re:|Subject:|SUBJECT:)", r"^FORMAL DISPUTE", r"^NOTICE OF DISPUTE"],
    ),
    SectionSpec(
    ...
    SectionSpec(
        name="specific_violations",
        position=5,
        required=True,
        header_patterns=[
            r"^(III\.?\s+)?SPECIFIC VIOLATIONS",
            r"^(III\.?\s+)?DISPUTED ITEMS",
            r"^SECTION III",
            r"^Violations",
            r"^VIOLATIONS",
            r"^Disputed Items",
    ...
    SectionSpec(
        name="reservation_of_rights",
        position=10,
        required=False,
        header_patterns=[
            r"^(VIII\.?\s+)?RESERVATION",
            r"^SECTION VIII",
            r"^Reservation",
            r"^RIGHTS RESERVED",
        ],
    ...
    SectionSpec(
        ...
        required=True,
        header_patterns=[
            r"^(Respectfully|Sincerely|Thank you)",
            r"^_+",  # Signature line
        ],
    ),
    SectionSpec(
